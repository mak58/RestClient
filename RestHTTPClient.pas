...
type
  /// <summary>
  ///  Copyright (C) 2024 Márcio Koehler - Version 1.1
  ///  Types to reference "RestHttpClientTypes"
  /// </summary>
  TParamsRequest = TRequestParams;
  TResultRest = TResult;
  IRestHttp = IRestClient;
  ...
  public
   ...
   function MapGet(const payload: string = ''): TResultRest; virtual;
   function MapPost(const payload: string): TResultRest; virtual;
   function MapPut(const payload: string): TResultRest; virtual;
   function MapDelete(): TResultRest; virtual;

   constructor Create(const ARequestParams: TParamsRequest); virtual;
...
constructor THttpClientAPI.Create(const ARequestParams: TParamsRequest);
begin
...
procedure THttpClientAPI.ExecuteRequest(var ARequest: TResultRest);
begin
  try
    RestRequest.Execute();
...
function THttpClientAPI.MapGet(const payload: string = ''): TResultRest;
begin
...
function THttpClientAPI.MapPost(const payload: string): TResultRest;
begin
...
function THttpClientAPI.MapPut(const payload: string): TResultRest;
begin
...
function THttpClientAPI.MapDelete(): TResultRest;
begin
